...
public class vThirdPersonCamera : MonoBehaviour
{
    ...
    [Header("Quels obstacles la camera doit contourner")]
    public LayerMask cullingLayer = 1 << 0;
    // [Tooltip("Debug purposes, lock the camera behind the character for better align the states")]
    [HideInInspector]
    public bool lockCamera;
    [Header("Position Camera droite/gauche")]
    public float rightOffset = 0f;
    [Header("Distance camera/personnage")]
    public float defaultDistance = 2.5f;
    [Header("Hauteur Camera")]
    public float height = 1.4f;
    [Header("Sensibilité des mouvements camera")]
    public float xMouseSensitivity = 3f;
    public float yMouseSensitivity = 3f;
    [Header("Limites des mouvements camera")]
    public float yMinLimit = -40f;
    public float yMaxLimit = 80f;
	public float xMinLimit = -360f;
	public float xMaxLimit = 360f;

    [Header("Lissage des mouvements camera (pour eviter les accoups)")]
    [Tooltip("Lissage de la rotation de la camera")]
    public float smoothCameraRotation = 12f;
    [Tooltip("Lissage du mouvement de la camera")]
    ...
    private float clipPlaneMargin = -1f;
